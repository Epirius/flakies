...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- change language
    , ((modm .|. shiftMask, xK_l), spawn "./../bin/layout_switch.sh")
    ...
    -- Kill xmobar
    , ((modm              , xK_a     ), spawn "killall xmobar")
